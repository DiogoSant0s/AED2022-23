...
TEST(test_, loadObjects) {
    ...
    unsigned int objsNotLoaded  = objects.size();
...
TEST(test_, packObjects) {
    ...
    vector<Object> objects;
    objects.emplace_back(Object(1, 2)); objects.emplace_back(Object(2, 11));
    objects.emplace_back(Object(3, 17)); objects.emplace_back(Object(4, 3));
    objects.emplace_back(Object(5, 9)); objects.emplace_back(Object(6, 4));
    objects.emplace_back(Object(7, 2)); objects.emplace_back(Object(8, 12));
    objects.emplace_back(Object(9, 7)); objects.emplace_back(Object(10, 10));
    objects.emplace_back(Object(11, 10)); objects.emplace_back(Object(12, 1));
...
TEST(test_, boxWithMoreObjects) {
    ...
    objects.emplace_back(Object(4, 3));
    objects.emplace_back(Object(5, 9));
    objects.emplace_back(Object(6, 4));
    objects.emplace_back(Object(7, 2));
    objects.emplace_back(Object(9, 7));
    objects.emplace_back(Object(10, 10));
    objects.emplace_back(Object(11, 10));
    objects.emplace_back(Object(12, 1));
