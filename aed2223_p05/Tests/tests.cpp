...
TEST(test, overlappingIntervals) {
    ...
    values1.emplace_back(2, 4);
    values1.emplace_back(6, 8);
    values1.emplace_back(1, 3);
    values1.emplace_back(9, 10);
    ...
    values2.emplace_back(6, 8);
    values2.emplace_back(1, 9);
    values2.emplace_back(2, 4);
    values2.emplace_back(4, 7);
    ...
    values3.emplace_back(2, 7);
    values3.emplace_back(1, 3);
    values3.emplace_back(5, 8);
    values3.emplace_back(9, 9);
...
TEST(test, shuffle){
    ...
    list<Kid> kids;
    kids.emplace_back("Rui",6,'m' );
    kids.emplace_back("Ana",4,'f' );
    kids.emplace_back("Rita",3,'f' );
    kids.emplace_back("Joao",5,'m' );
    kids.emplace_back("Marta",7,'f' );
    kids.emplace_back("Vasco",5,'m' );
    kids.emplace_back("Ines",5,'f' );
